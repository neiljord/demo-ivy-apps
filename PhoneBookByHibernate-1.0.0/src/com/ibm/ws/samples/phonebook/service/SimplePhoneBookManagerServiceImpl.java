 ...
 */
package com.ibm.ws.samples.phonebook.service;

import com.ibm.ws.samples.phonebook.PhoneBookEntry;
import com.ibm.ws.samples.phonebook.dao.SimplePhoneBookManager;
...
@Service
public class SimplePhoneBookManagerServiceImpl implements SimplePhoneBookManagerService {
    @Autowired
    private SimplePhoneBookManager phoneBookDAO;

    @Transactional
    public List<PhoneBookEntry> listPhones() {
        return phoneBookDAO.listPhones();
    }
